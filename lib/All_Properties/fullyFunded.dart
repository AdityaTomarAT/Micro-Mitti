...
class FullFundedProperties extends StatefulWidget {
  const FullFundedProperties({super.key});

  @override
  State<FullFundedProperties> createState() => _FullFundedPropertiesState();
}

class _FullFundedPropertiesState extends State<FullFundedProperties> {
  @override
  void initState() {
    super.initState();
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  var filteredList = snapshot.data!.docs
                      .where((item) => item['type'] == "fully funded")
                      .toList();
